...
<body>
 <!-- header begin 
			...
			<div class="aui-head-box top">
				<div class="aui-container">
					<div class="aui-head-logo">
						<a href="/main" title="国富通"><img src="/images/logo.png" alt="国富通"></a>
					</div>
	...
	<!-- web begin -->
		<section id="aui-web">
			<div class="aui-firstBox-title">
				<h1>逾十个行业已在国富通计算平台</h1>
				<p>助力企业通过国富通计算实现互联网</p>
			</div>
	...
	<!-- second begin-->
		<section id="second-box">
			<div class="aui-second-box" style="height:630px;">
				<div class="aui-container">
					<div class="aui-firstBox-title">
						<h1>50,000+ 企业一起使用国富通</h1>
						<p>目前国富通服务多家企业，分布在银行、保险、电力、互联网、制造业、教育等领域</p>
					</div>
					<div class="aui-partner clearfix">
						<ul>
							<li><a href="#"  target="_blank"><img src="img/ad/ad1.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad2.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad3.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad4.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad5.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad6.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad7.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad8.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad9.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad10.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad11.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad12.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad13.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad14.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad15.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad16.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad17.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad18.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad19.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad20.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad21.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad22.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad23.png" alt=""></a></li>
							<li><a href="#"  target="_blank"><img src="img/ad/ad24.png" alt=""></a></li>
						</ul>
					</div>
				</div>
			</div>
